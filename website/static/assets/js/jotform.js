    ...
    mobileTouchlessModeTest: function () {
        ...
        if (window.FORM_MODE == 'cardform') {
          if ($(document.body).hasClassName('welcomeMode')) {
            ...
            var firstCard = document.querySelector('.form-line .jfCard');

            if (firstCard) {
                firstCard.classList.add('with-qr')
